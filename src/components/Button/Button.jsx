...
export const Button = (props) => {
    const { children, importance = "secondary", inverse = false, full = false } = props
    const variant = importance === 'primary' ? 
    'contained' : 'outlined'

    return (
        <StyledButton size="large" importance={importance} inverse={inverse} variant={variant} full={full}>{children}</StyledButton>
    )
}
